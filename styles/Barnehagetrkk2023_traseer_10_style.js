var size = 0;
var placement = 'point';
function categories_Barnehagetrkk2023_traseer_10(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Blå':
...
case 'Rosa':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(204,102,153,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 5.548}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_Barnehagetrkk2023_traseer_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Barnehagetrkk2023_traseer_10(feature, value, size, resolution, labelText,
