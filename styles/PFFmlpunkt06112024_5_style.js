...
var style_PFFmlpunkt06112024_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_PFFmlpunkt06112024_5(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_PFFmlpunkt06112024_5rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_PFFmlpunkt06112024_5rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 10.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_PFFmlpunkt06112024_5rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_PFFmlpunkt06112024_5rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 8.0 + size,
                                          points: 4,
                                          radius2: 0,
        ...
        var style = rules_PFFmlpunkt06112024_5(feature, value);
        ;
